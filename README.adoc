...
:experimental:
:url-github: https://github.com/hyperpolymath/bofig
:url-gitlab: https://gitlab.com/hyperpolymath/bofig
:url-bitbucket: https://bitbucket.org/hyperpolymath/bofig
:url-codeberg: https://codeberg.org/hyperpolymath/bofig

Build-Once-Fix-In-Git configuration management
...
bofig is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
