...
[width="100%",cols="36%,35%,29%",options="header",]
|===
|Component |Technology |Purpose
|Web UI |Phoenix LiveView + D3.js |Real-time investigation dashboard,
graph viz, PROMPT radar

|GraphQL API |Absinthe 1.7 |Typed query/mutation interface for claims,
evidence, navigation
...
|Graph DB |ArangoDB 3.11 (Arangox) |Claims, evidence, relationships,
navigation paths
...
[width="100%",cols="37%,22%,41%",options="header",]
|===
|Directory |Files |Description
|`+lib/evidence_graph/+` |28 .ex |Core business logic (contexts,
schemas, workers)

|`+lib/evidence_graph_web/+` |25 .ex |Web layer (router, controllers,
LiveView, GraphQL)
