...
export
%foreign "C:evidence_graph_process, libevidence_graph"
...
||| Process array data
export
%foreign "C:evidence_graph_process_array, libevidence_graph"
...
||| Register a callback
export
%foreign "C:evidence_graph_register_callback, libevidence_graph"
...
registerCallback h cb = do
  -- NOTE: Callback registration is a placeholder; real implementation
  -- must use a proper C function pointer obtained via %foreign.
  result <- primIO (prim__registerCallback (handlePtr h) prim__nullAnyPtr)
  pure $ case resultFromInt result of
    Just Ok => Right ()
    Just err => Left err
    Nothing => Left Error
