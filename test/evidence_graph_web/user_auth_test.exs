...
defmodule EvidenceGraphWeb.UserAuthTest do
  use EvidenceGraphWeb.ConnCase, async: true

  alias EvidenceGraph.Accounts
  alias EvidenceGraph.Accounts.Scope
  alias EvidenceGraphWeb.UserAuth

  import EvidenceGraph.AccountsFixtures

  @remember_me_cookie "_evidence_graph_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EvidenceGraphWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
