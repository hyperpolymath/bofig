...
Per the link:../.claude/CLAUDE.md[language policy], we use AffineScript for frontend code and avoid Python/Node.js.
...
Yes! The project is open source from day 1. See the link:../.github/CONTRIBUTING.md[CONTRIBUTING] guide.
